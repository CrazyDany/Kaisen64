...
local function treadmill_scroll_right(input_vtx, original_uv, current_uv)
    local speed = 35
...
hook_event(HOOK_ON_SYNC_VALID, function()
    if gNetworkPlayers[0].currLevelNum == LEVEL_ARENA then
        ...
        UvScroll.hook_scrolling_function('arena_dl_Treadmill_001_mesh_layer_1_tri_0', treadmill_scroll_right)
    end
end)